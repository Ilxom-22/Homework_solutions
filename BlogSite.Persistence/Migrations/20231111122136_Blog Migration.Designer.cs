...
namespace BlogSite.Persistence.Migrations
{
    ...
    [Migration("20231111122136_Blog Migration")]
            ...
            modelBuilder.Entity("BlogSite.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2023, 11, 11, 12, 21, 36, 299, DateTimeKind.Unspecified).AddTicks(4805), new TimeSpan(0, 0, 0, 0, 0)),
                            IsRevoked = false,
                            Type = 0
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2023, 11, 11, 12, 21, 36, 299, DateTimeKind.Unspecified).AddTicks(4809), new TimeSpan(0, 0, 0, 0, 0)),
                            IsRevoked = false,
                            Type = 1
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2023, 11, 11, 12, 21, 36, 299, DateTimeKind.Unspecified).AddTicks(4810), new TimeSpan(0, 0, 0, 0, 0)),
                            IsRevoked = false,
                            Type = 2
                        });
                });
