...
namespace BlogSite.Persistence.Migrations
{
    ...
    [Migration("20231112113651_Comment table update")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlogSite.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2023, 11, 12, 11, 36, 51, 804, DateTimeKind.Unspecified).AddTicks(2921), new TimeSpan(0, 0, 0, 0, 0)),
                            IsRevoked = false,
                            Type = 0
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2023, 11, 12, 11, 36, 51, 804, DateTimeKind.Unspecified).AddTicks(2926), new TimeSpan(0, 0, 0, 0, 0)),
                            IsRevoked = false,
                            Type = 1
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2023, 11, 12, 11, 36, 51, 804, DateTimeKind.Unspecified).AddTicks(2928), new TimeSpan(0, 0, 0, 0, 0)),
                            IsRevoked = false,
                            Type = 2
                        });
                });
            ...
            modelBuilder.Entity("BlogSite.Domain.Entities.Blog", b =>
                {
                    b.HasOne("BlogSite.Domain.Entities.User", "Author")
                        .WithMany()
