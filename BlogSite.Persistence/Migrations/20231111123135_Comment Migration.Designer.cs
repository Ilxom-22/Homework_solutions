...
namespace BlogSite.Persistence.Migrations
{
    ...
    [Migration("20231111123135_Comment Migration")]
            ...
            modelBuilder.Entity("BlogSite.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2023, 11, 11, 12, 31, 35, 801, DateTimeKind.Unspecified).AddTicks(7152), new TimeSpan(0, 0, 0, 0, 0)),
                            IsRevoked = false,
                            Type = 0
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2023, 11, 11, 12, 31, 35, 801, DateTimeKind.Unspecified).AddTicks(7157), new TimeSpan(0, 0, 0, 0, 0)),
                            IsRevoked = false,
                            Type = 1
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2023, 11, 11, 12, 31, 35, 801, DateTimeKind.Unspecified).AddTicks(7159), new TimeSpan(0, 0, 0, 0, 0)),
                            IsRevoked = false,
                            Type = 2
                        });
                });
